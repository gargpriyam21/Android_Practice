...
public class Activity_LR extends AppCompatActivity {
    ...
    private void gameOver() {
        ...
        updateHistory(Score + "/" + QuestionLength);
    ...
    private void updateHistory(String Score) {
        ...
        SQLiteDatabase historyDB = new HistoryDBHelper(Activity_LR.this).getWritableDatabase();

        Log.d("QUIZ", "Score:" + Score + " And Date:" + curDate);
